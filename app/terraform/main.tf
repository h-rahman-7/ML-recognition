...
module "ecs" {
  ...
  task_family        = "mlops-task"
  task_cpu           = "2048"
  task_memory        = "6144"
  repository_name    = "mlops"
  container_name     = "mlops-container"
  container_image    = "713881828888.dkr.ecr.us-east-1.amazonaws.com/mlops:latest"
  container_port     = 3000
...
module "route53" {
  ...
  record_name = "mlops.habibur-rahman.com"
  ttl         = 300
